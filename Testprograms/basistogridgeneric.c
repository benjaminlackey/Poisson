...
printf("Time = %f", ratio*(long)t1 + ratio*(long)t2 ); 
  ...
  int nz = 3;
  int nr = 25 /*5*/; /* must be odd? */
  int nt = 13 /*7*/;
  int np = 12 /*6*/; /* must be even */
  int npc;
  scalar2d *b_zjk;
...
/*   } */
  ...
  fouriertogrid_xideriv(c_zijk, coeff_zijk, 0, 0, 0);
  t9 = clock(); 
  print_scalar3d(c_zijk);
  t10 = clock(); 
  gridtofourier(coeff_zijk, c_zijk);
  ...
  printf("\nt1=%f\nt2=%f\nt3=%f\nt4=%f\nt5=%f\nt6=%f\nt7=%f\nt8=%f\nt9=%f\nt10=%f\nt11=%f\nt12=%f\n", ratio*t1, ratio*t2, ratio*t3, ratio*t4, ratio*t5, ratio*t6, ratio*t7, ratio*t8, ratio*t9, ratio*t10, ratio*t11 , ratio*t12); 
